...
public class DenunciaDAO {
    ...
    public List<Map<String, Object>> listarDenuncias() {
        ...
        while (cursor.moveToNext()) {
            ...
            denuncia.put(DatabaseHelper.Denuncia.LATITUDE, longitude);
            denuncia.put(DatabaseHelper.Denuncia.LONGITUDE, latitude);
            denuncia.put(DatabaseHelper.Denuncia.URI_MIDIA, uriMidia);
    ...
    public long inserirDenuncia(Denuncia denuncia) {
        ...
        values.put(DatabaseHelper.Denuncia.URI_MIDIA, denuncia.getUriMidia());
    ...
    private Denuncia criarDenuncia(Cursor cursor) {
        ...
        String usuario = cursor.getString(cursor.getColumnIndex(DatabaseHelper.Denuncia.USUARIO));
        String categoria = cursor.getString(cursor.getColumnIndex(DatabaseHelper.Denuncia.CATEGORIA));
        Denuncia denuncia = new Denuncia(id, descricao, data, latitude, longitude, uriMidia, usuario, categoria);
        return denuncia;
    }
